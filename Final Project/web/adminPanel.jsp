...
<div class="container" style="min-height: 500px;">
    ...
    <div class="row mt-3">
        <div class="col-12">
            ...
            %>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>The news successfully  deleted :)</strong>
                <button type="close" class="close" data-dismiss="alert" aria-label="Close" style="background-color: transparent; border-color: transparent">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="modal-body">
                            <form action="/addNews" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="i_category_id" class="form-control">
                                        <%
                                            ArrayList<Category> categories = (ArrayList<Category>) request.getAttribute("tipy");
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="i_language_id" class="form-control">
                                        <%
                                            ArrayList<Language> languages = (ArrayList<Language>) request.getAttribute("yazyki");
                                            for (Language l : languages ) {
                                        %>
                                        <option value="<%=l.getId()%>"><%=l.getName() + " / "+l.getCode()%></option>
                                        <%
                                            }
                                        %>
                                    </select>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <%=n.getContent().getTitle()%>
                    </td>
                    <td>
                        <%=n.getPostedDate()%>
                    </td>
                    <td>
                        <%=n.getContent().getLanguage().getCode()%>
                    </td>
                    <td style="width: 220px">
                        <a href="/newsDetails?id=<%=n.getId()%>&adminPanel" class="btn btn-danger btn-sm">DETAILS</a>
                    </td>
                </tr>
                <%
                        }
